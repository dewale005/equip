                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            <div class="card-body py-16pt text-center">
                                ...
                                @if (HasEnrolled($course->id, Auth::user() ))
                                    <h4 class="card-title"><strong>You have already registered for this Course</strong>
                                    </h4>
                                @else
                                    <h4 class="card-title"><strong>Register for this Course</strong></h4>
                                @endif
                                <p class="card-subtitle text-70 mb-24pt">Get access to all videos in the Course</p>
                                @if (HasEnrolled($course->id, Auth::user() ))
                                    <a href="{{ route('enrollment.lesson', $course->id) }}"
                                        class="btn btn-primary mb-8pt">Continue Course</a>
                                @else
                                    {!! Form::open(['route' => ['enrollment.store', $course->id]]) !!}
                                    {!! Form::submit('Register for this Course', ['class' => 'btn btn-accent mb-8pt']) !!}
                                    {!! Form::close() !!}
                                @endif
