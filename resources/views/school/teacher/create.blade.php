            ...
            <div
                ...
                <div class="flex d-flex flex-column flex-sm-row align-items-center">
                    ...
                    <div class="mb-24pt mb-sm-0 mr-sm-24pt">
                        <h2 class="mb-0">Create a new teacher</h2>
            ...
            <div class="col-md-6 ">
                ...
                <div class="avatar-upload">
                    ...
                    <div class="avatar-preview">
                        <div id="imagePreview" style="background-image: url(null);">
                        </div>
                    </div>
                    @error('avatar')
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('title', null, array_merge(['class' => 'form-control', 'placeholder' => "Teacher's title ..."])) }}
                    @error('title')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('full_name', null, array_merge(['class' => 'form-control', 'placeholder' => 'Teachers full name ...'])) }}
                    @error('full_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    {{ Form::textarea('description', null, array_merge(['class' => 'form-control', 'placeholder' => "Teacher's bio ..."])) }}
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('facebook', null, array_merge(['class' => 'form-control', 'placeholder' => 'Teachers Facebook handle ...'])) }}
                    @error('facebook')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('instagram', null, array_merge(['class' => 'form-control', 'placeholder' => 'Teachers Instagram handle ...'])) }}
                    @error('instagram')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
