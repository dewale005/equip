                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span class="chip chip-outline-secondary d-inline-flex align-items-center" data-toggle="tooltip"
                                ...
                                <i class="material-icons icon--left">opacity</i> 0 points
                            </span>
                            ...
                            <div class="col-md-6 card-group-row__col">
                                ...
                                <div class="card card-group-row__card">
                                    <div class="card-header d-flex align-items-center border-0">
                                        <div class="h2 mb-0 mr-3">{{ $user->referrals->count() }}</div>
                                        <div class="flex">
                                            <p class="card-title">Referals</p>
                                            <p class="card-subtitle text-50">Total number of referals</p>
                                        </div>
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <a href="student-take-quiz.html"
                                            ...
                                            <img src="../../public/images/paths/typescript_200x168.png"
                                                alt="Introduction to TypeScript" class="avatar-img rounded">
                                    ...
                                    <div class="card-body d-flex align-items-center">
                                        <a href="student-take-quiz.html"
                                            ...
                                            <img src="../../public/images/paths/angular_200x168.png"
                                                alt="Angular Fundamentals" class="avatar-img rounded">
                                            <span class="overlay__content"></span>
                                        </a>
                                        <div class="flex mr-12pt">
                                            <a class="card-title" href="student-take-quiz.html">Angular
                                                Fundamentals</a>
                                            <div class="card-subtitle text-50">3 days ago</div>
                                        </div>
                                        <div class="d-flex flex-column align-items-center">
                        ...
                        <div class="row card-group-row">
                            ...
                            <div class="col-sm-6 col-xl-4 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card undefined"
                                    ...
                                    <div class="card-body flex">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title" href="student-take-course.html">Learn Angular
                                                    fundamentals</a>
                                                <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                            </div>
                                            <a href="student-take-course.html" data-toggle="tooltip"
                                ...
                                <div class="popoverContainer d-none">
                                    <div class="media">
                                        <div class="media-left mr-12pt">
                                            <img src="../../public/images/paths/angular_40x40@2x.png" width="40" height="40"
                                    ...
                                    <div class="my-32pt">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <a href="student-take-course.html" class="btn btn-outline-secondary ml-0">Start
                                                over</a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-4 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card undefined"
                                    ...
                                    <div class="card-body flex">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title" href="student-take-course.html">Build an iOS
                            ...
                            <div class="col-sm-6 col-xl-4 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card undefined"
                                    ...
                                    <div class="card-body flex">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title" href="student-take-course.html">Build a WordPress
                                                    Website</a>
                                                <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                            </div>
                                            <a href="student-take-course.html" data-toggle="tooltip"
                            ...
                            <div class="col-sm-6 col-xl-4 card-group-row__col">
                                ...
                                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card d-xl-none"
                                    ...
                                    <a href="student-take-course.html" class="card-img-top js-image" data-position="left"
                                        data-height="140">
                                    ...
                                    <div class="card-body flex">
                                        <div class="d-flex">
                                            <div class="flex">
                                                <a class="card-title" href="student-take-course.html">Become a React
                                                    Native Developer</a>
                                                <small class="text-50 font-weight-bold mb-4pt">Elijah Murray</small>
                                            </div>
                                            <a href="student-take-course.html" data-toggle="tooltip"
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active">
                                    ...
                                    <a class="card border-0 mb-0" href="">
                                        <img src="../../public/images/achievements/flinto.png" alt="Flinto"
                                            ...
                                            <span class="row flex-nowrap">
                                                ...
                                                <span class="col d-flex flex-column">
                                                    <span class="text-right flex mb-16pt">
                                                        <img src="../../public/images/paths/flinto_40x40@2x.png" width="64"
                                ...
                                <div class="carousel-item">
                                    ...
                                    <a class="card border-0 mb-0" href="">
                                        <img src="../../public/images/achievements/angular.png" alt="Angular fundamentals"
                                            class="card-img" style="max-height: 100%; width: initial;">
                                        <div class="fullbleed bg-primary" style="opacity: .5;"></div>
                                        <span
                                            class="card-body d-flex flex-column align-items-center justify-content-center fullbleed">
                                            <span class="row flex-nowrap">
                                                ...
                                                <span class="col d-flex flex-column">
                                                    <span class="text-right flex mb-16pt">
                                                        <img src="../../public/images/paths/angular_64x64.png" width="64"
                                            ...
                                            <span class="row flex-nowrap">
                                                ...
                                                <span class="col d-flex flex-column">
                                                    <span>
                                                        <span class="card-title text-white mb-4pt d-block">Angular
                                                            fundamentals</span>
