			...
			$('[data-toggle="quill"]').each(function() {
				var e = $(this),
					t = {
						...
						placeholder:
							void 0 !== e.data('quill-placeholder')
								? e.data('quill-placeholder')
								: Quill.DEFAULTS.placeholder,
						readOnly:
							void 0 !== e.data('quill-read-only') ? e.data('quill-read-only') : Quill.DEFAULTS.readOnly,
					...
					l = e.get(0),
					r = new Quill(l, t);
				Object.defineProperty(l, 'Quill', { configurable: !0, writable: !1, value: r });
			});
		})();
	}
});
